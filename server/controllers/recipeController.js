...
exports.homepage = async(req, res) => {
  try {
    ...
    const cocktails = await Recipe.find({ 'category': 'Cocktails' }).limit(limitNumber);
    const holiday = await Recipe.find({ 'category': 'Holiday' }).limit(limitNumber);

    const food = { latest, dinner, bakedgoods, dessert ,cocktails,holiday};
